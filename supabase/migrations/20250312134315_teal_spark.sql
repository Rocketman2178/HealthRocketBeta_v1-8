/*
  # Fix Device Connection Timestamp Reference

  1. Changes
    - Fix timestamp column reference in get_vital_link_token function
    - Use connected_at instead of created_at for timestamp checks
    - Improve error handling for connection validation
*/

-- Update get_vital_link_token function to use correct timestamp column
