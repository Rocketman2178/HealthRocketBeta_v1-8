...
SELECT 'api_key', 'sk_us_TuRgU6jA3MA-OMBVqWlBOLKQ-NE1cOQNzWh8O5u00fY'
WHERE NOT EXISTS (SELECT 1 FROM public.vital_config WHERE name = 'api_key');

INSERT INTO public.vital_config (name, value)
SELECT 'environment', 'sandbox'
WHERE NOT EXISTS (SELECT 1 FROM public.vital_config WHERE name = 'environment');

INSERT INTO public.vital_config (name, value)
SELECT 'webhook_secret', 'whsec_Ug7Ipf44N8+d5leHKQamzcu9GR1rtksV'
WHERE NOT EXISTS (SELECT 1 FROM public.vital_config WHERE name = 'webhook_secret');
